...
// Prints character and increments cursor
 ...
 */
inline static void _display_set_data_read_mode_(enum display_register_select register_select);
...
* @param register_select DISPLAY_INSTR_REG for instruction register and DISPLAY_DATA_REG for data register
 */
inline static void _display_set_data_write_mode_(enum display_register_select register_select);
 ...
 */
inline static char _display_extract_data_(uint32_t gpio_data);
